...
export default class 鍵盤 extends React.Component {
  ...
  render () {
    let 一般符號陣列 = [
      ['⿰', '⿱', '⿴'],
      ['⿰亻', '⿰糸', '⿰', '⿰爿'],  // HACK: 私有字「」用於提供臺式筆劃的「糹」，若無需區別可替換之。
      ['⿰扌', '⿰⺉', '⿱艹'],
      ['⿴囗', '⿴辶', '⿴气', '⿴宀'],
      ['⿰亻因', '⿱任心', '⿴囗或'],
      ['⿱金⿰金金', '⿱⿰火火⿰火火'],
    ...
    let 注音陣列 = [
      ['⿿', '⿿⿿⿿ㄍㄨ㆐ㆵ', '⿿⿿ㆠㄞˋ'],  // HACK: 自訂注音用 IDC，TODO 文檔
      ['ㄅ', 'ㄆ', 'ㄇ', 'ㆠ', 'ㄈ', 'ㄪ'],
      ['ㄉ', 'ㄊ', 'ㄋ', 'ㄌ'],
      ['ㄍ', 'ㄎ', 'ㄏ', 'ㆣ', 'ㄫ'],
      ['ㄐ', 'ㄑ', 'ㄒ', 'ㆢ', 'ㄬ'],
      ...
      ['ㄗ', 'ㄘ', 'ㄙ', 'ㆡ'],
      ['ㄧ', 'ㆪ', 'ㄨ', 'ㆫ', 'ㆨ', 'ㄩ'],
      ['ㄚ', 'ㆩ', 'ㄛ', 'ㆦ', 'ㆧ', 'ㄜ', 'ㄮ'],  // HACK: 最後一個 U+312F 是自訂空白注音字元，TODO 文檔
      ['ㄝ', 'ㆤ', 'ㆥ', 'ㄞ', 'ㆮ', 'ㄟ', 'ㄠ', 'ㆯ', 'ㄡ'],
      ['ㆬ', 'ㆰ', 'ㆱ', 'ㄢ', 'ㄣ', 'ㄤ', 'ㆲ', 'ㆭ', 'ㄥ', 'ㄦ'],
      ['ˊ', 'ˇ', 'ˋ', '˙', '˪', '˫', '^', '㆐'],
      ['ㆴ', 'ㆵ', 'ㆶ', 'ㆷ'],
    ...
    return (
      <div>
        ...
        <div style={{ paddingLeft: '2em' }}>
          ...
          <p>⿰亻因＝<span className="wordpq">亻因</span>＝<span className="wordpq">亻<span className="wordoo">囗大</span></span></p>  
        </div>
        
        <p>像是閩南語的「⿰亻因」和客語的「⿰亻厓」以往只能造字，還得製作字型檔才能使用，因此本站提供跨平台的組字工具。
