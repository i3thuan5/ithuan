      ...
      <Container text>
        ...
        <Item.Group relaxed>
          <SingleItem title=" MisanoPangcah/'Amis" logo={ LogoMisanoPangcah } url="https://apps.apple.com/tw/app/misanopangcah-amis/id6450070292" meta="阿美語口說練習"
            >MisanoPangcah/‘Amis app是一個阿美語跟讀練習app，聽一遍例句發音後，再跟著唸一遍，語音辨識結果可以讓你馬上知道哪裡唸得與例句不同，並且為你的發音評分。（本計畫感謝文化部語言友善環境及創作應用與推廣補助）
            <Link to="/misanopangcah">
          隱私權保護政策</Link></SingleItem>
