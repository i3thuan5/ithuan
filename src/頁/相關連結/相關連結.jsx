    ...
    return (
      <Container text>
        ...
        <List>
          ...
          <List.Item as='a' href="https://ws.moe.edu.tw/001/Upload/6/relfile/6507/7818/73d03702-3903-4123-9801-f8264d623443.pdf" target="_blank">教育部客家語拼音輸入法</List.Item>
          <List.Item as='a' href="http://taigi.fhl.net/TaigiIME/" target="_blank">信望愛台語客語輸入法</List.Item>
        ...
        <Segment basic size="large">
        <List>
          <List.Item>原住民族語 教學＆辭典</List.Item>
          <List.Item as='a' href="http://web.klokah.tw/" target="_blank">族語E樂園</List.Item>
          <List.Item as='a' href="http://ilrdc.tw/research/athousand/explain.php" target="_blank">族語千詞表</List.Item>
          <List.Item as='a' href="https://m-dictionary.apc.gov.tw/" target="_blank">原住民族語言線上詞典</List.Item>
          <List.Item as='a' href="http://tayal.pqwasan.org.tw/kmal/desktop/index.php" target="_blank">賽考利克泰雅語 - 線上辭典</List.Item>
        </List>  
        </Segment>
      
        <Segment basic size="large">
            <p>會持續更新清單，嘛歡迎來批和阮分享！</p>
        </Segment>
      </Container>
    );
  }
