    ...
    return (
      <Container text>
        ...
        <Segment basic size="large">
          ...
          <p>因為狗、頭、後在古代漢語是押韻的，可以推測從古代漢語分化成華閩客三種方言後，狗、頭、後仍然互相押韻。</p>
          <p>換句話說，華閩客語繼承了古代漢語的押韻規律，所以推論：閩南語及客家話和華語一樣也繼承了漢字。</p>
          <p>不過，部份詞彙原來是沒有漢字的。
        ...
        <Segment basic size="large">
            ...
            <Icon name='info' />
            前一節提到狗、頭、後<br/>
            從《廣韻》來佐證這三個字同屬「侯韻」，遵循侯韻從中古音分化成華閩客的韻母，才會使這三個字在華閩客語都押韻。
            <Table striped unstackable>
            <Table.Header>
              <Table.Row>
                <Table.HeaderCell>範例字</Table.HeaderCell>
